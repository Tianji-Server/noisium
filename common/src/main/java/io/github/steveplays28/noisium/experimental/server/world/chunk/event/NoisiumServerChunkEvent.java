package io.github.steveplays28.noisium.experimental.server.world.chunk.event;
...
public interface NoisiumServerChunkEvent {
	...
	interface WorldChunkGenerated {
		/**
		 * Invoked after a {@link WorldChunk} has been generated by {@link io.github.steveplays28.noisium.experimental.server.world.NoisiumServerWorldChunkManager}.
		 *
	...
	interface LightUpdate {
		/**
		 * Invoked before a {@link WorldChunk} has had a light update processed by {@link io.github.steveplays28.noisium.experimental.server.world.NoisiumServerWorldChunkManager}.
		 *
	...
	interface BlockChange {
		/**
		 * Invoked before a {@link WorldChunk} has had a block change processed by {@link io.github.steveplays28.noisium.experimental.server.world.NoisiumServerWorldChunkManager}.
		 *
